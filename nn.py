...
print(na_mfcc_arr)
print(len(na_mfcc_arr))
print(type(na_mfcc_arr))
#na_mfcc_arr = array(na_mfcc_arr)
#print(type(na_mfcc_arr))

'''
print(na_mfcc_arr[0])
print(na_mfcc_arr[0].size)
print(type(na_mfcc_arr[0]))


print(na_mfcc_arr[0][0])
print(na_mfcc_arr[0][0].size)
print(type(na_mfcc_arr[0][0]))
'''

#print(na_mfcc_arr.shape)
...
#na_mfcc_arr = na_mfcc_arr.reshape(na_mfcc_arr.shape[0], na_mfcc_arr.shape[1], na_mfcc_arr.shape[2], 1)
#ind_mfcc_arr = ind_mfcc_arr.reshape(ind_mfcc_arr.shape[0], ind_mfcc_arr.shape[1], ind_mfcc_arr.shape[2], 1)
...
#print(data_arr.shape[0], 'test samples')
#print(ind_mfcc_arr.shape[0], 'test samples')
...
print("")
#print(data_arr.shape)
#print(numpy.delete(data_arr, 0, 0).shape)

#K-Folds X-validation
